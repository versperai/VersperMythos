...
from src.lm.lora import apply_lora, load_lora
from src.lm.trainer.trainer_utils import setup_seed, get_model_params
...
def main():
    ...
    parser.add_argument('--save_dir', default='out/lm', type=str, help="模型权重目录")
    ...
    parser.add_argument('--num_key_value_heads', default=2, type=int, help="KV头数")
