...
from model.model_minimind import LMConfig, LMForCausalLM
...
if __name__ == '__main__':
    lm_config = LMConfig(hidden_size=512, num_hidden_layers=8, max_seq_len=8192, use_moe=False)
    torch_path = f"out/lm/full_sft_{lm_config.hidden_size}{'_moe' if lm_config.use_moe else ''}.pth"
