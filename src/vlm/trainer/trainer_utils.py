"""
Shared training utilities for MiniMind-VLM.
"""
import os
import random
import math
...
from src.vlm.model_vlm import VLM
...
def init_vlm_model(vlm_config, from_weight='pretrain_vlm', tokenizer_path='model/tokenizer',
                   vision_model_path='model/siglip2-base-p32-256-ve',
                   save_dir='out/vlm', device='cuda', freeze_llm=0):
    ...
    # Freeze all by default, only vision_proj trainable
...
def vlm_checkpoint(vlm_config, weight='pretrain_vlm', model=None, optimizer=None,
                   epoch=0, step=0, wandb=None, save_dir='checkpoints/vlm', **kwargs):
